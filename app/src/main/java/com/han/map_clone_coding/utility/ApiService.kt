package com.han.map_clone_coding.utility

import com.han.map_clone_coding.Key
import com.han.map_clone_coding.Url
import com.han.map_clone_coding.response.address.AddressInfoResponse
import com.han.map_clone_coding.response.search.SearchResponse
...
interface ApiService {
    ...
    suspend fun getSearchLocation(
        @Header("appKey") appKey: String = Key.T_MAP_API,
